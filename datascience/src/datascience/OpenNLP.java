...
public class OpenNLP {
	...
	public static void main(String[] args)
	{
	      ...
	      try { 
	         useOpenNlp("My name is Rushdi Shams. " 
	               + "You can use Dr. before my name as I have a Ph.D. " 
	               + "but I am a bit shy to use it.", "C:/en-sent.bin", 
	                 "sentence"); 
	         useOpenNlp("\"Let's get this vis-a-vis\", \"he said,\" "
	         +"these boys marks are really that well?\"", 
	         "D:\\Softwares\\Jars\\NLP\\en-token.bin", "word"); 
	      } catch (IOException e) { 
	      } 
	...
	static void useOpenNlp(String sourceText, String modelPath, 
